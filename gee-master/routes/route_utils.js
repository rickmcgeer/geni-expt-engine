...
module.exports = function(urls) {
	...
	this.render_error_page = function(req, res, bug_subject, bug_body_comment) {
		var date = Date();
	...
	this.render_slice_dashboard = function(req, res, slice_dictionary) {
	...
	this.get_user_dashboard = function(req, res) {
	...
	this.ensure_items_in_a_list = function(input_parm) {
	...
	this.validate_username = function(username) {
