module.exports = function (app, utils, DB, urls) {
	...
	var addNode = function(req, res, argStruct) {
		if (!argStruct.ipAddress) {
			argStruct.ipAddress = getRequestorIP(#!/usr/bin/python
...
if __name__ == '__main__':
    ...
    parser.add_argument('-ipAddress', type=str, narg=1, require=False, help='ip Address for the new node')
    args = parser.parse_args()
    if args.ipAddress:
        if (args.ipAddress.startsWith('127.0')
            ip - getIp()
