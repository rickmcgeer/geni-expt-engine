...
# To these options, added the option --generateInventory.  If called with this and the --list flag, will generate 
# and print an Ansible inventory file.  This  is to generate the Ansible files to be bundled with the slicelet tarball.
#
import argparse
import json
